    ...
    <div class="container">
        ...
        <form method="POST" action="{{ route('login') }}" class="checkout-form">
            ...
            <div style="display: flex; justify-content: space-between; align-items: center; margin-top: 1rem;">
                ...
                <a href="{{ route('register') }}" class="underline text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Not registered?</a>
            </div>

            <button type="submit" class="checkout-btn" style="margin-top: 2rem;">Log in</button>
        </form>
    </div>
@endsection